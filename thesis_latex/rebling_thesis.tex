...
\Large
\textbf{Master Thesis\\
Europhotonics Master's Program\\
\vspace{1em}
\huge
Acquisition Optimization in Raster-Scan Optoacoustic Mesoscopy}\\
\vspace{1em}
\Large
\textit{``Fancy a nice Quote?''}\\- The Riddler aka the Ezequiel\\
\vspace{2em}
\Large
Johannes Rebling\\
\vspace{.2em}
